...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "fioriproject/test/integration/FirstJourney",
    "fioriproject/test/integration/ProjectListJourney",
    "fioriproject/test/integration/ProjectObjectPageJourney",
    "fioriproject/test/integration/MemberObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
